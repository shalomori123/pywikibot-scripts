...
#run(call + ['keta 3.0', '-prefixindex:רוקח על שיר השירים ', '-titles'])
#run(call + ['split bot', '-regex:= פרק (.) =', '-notitle', '-base_name:רוקח על שיר השירים ', '-page:רוקח על שיר השירים'])
...
#run(call + ['rename bot', '-change:אורות ישראל פרק (.) פסקה (.+)$', '-to:אורות/אורות ישראל/פרק \\1/\\2', '-regex', '-prefixindex:אורות ישראל', '-summary:שינוי שם למהדורה'])
#run(call + ['rename bot', '-change:אורות ישראל פרק (.)$', '-to:אורות/אורות ישראל/פרק \\1', '-regex', '-prefixindex:אורות ישראל', '-summary:שינוי שם למהדורה'])
...
#run(call + [site, user, 'rename bot', '-change:נדה', '-to:נידה', '-catr:מסכת נידה', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
#run(call + [site, main_user, 'rename bot', '-change:נדה', '-to:נידה', '-catr:מסכת נידה', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
...
#run(call + [site, user, 'rename bot', '-change:מקואות', '-to:מקוואות', '-catr:מסכת מקואות', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
#run(call + [site, main_user, 'rename bot', '-change:מקואות', '-to:מקוואות', '-catr:מסכת מקואות', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
...
#run(call + [site, user, 'rename bot', '-change:ידים', '-to:ידיים', '-catr:מסכת ידים', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
...
#run(call + [site, user, 'rename bot', '-change:עדיות', '-to:עדויות', '-catr:מסכת עדיות', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
...
#run(call + [site, user, 'rename bot', '-change:קנים', '-to:קינים', '-catr:מסכת קנים', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
#run(call + ['replace', '|קנים|', '|קינים|', '|קנים}}', '|קינים}}', '|על קנים|', '|על קינים|', '-catr:מסכת קנים', '-summary:התאמת שם המסכת לכתיב מלא בתבניות'])
#run(call + [site, user, 'rename bot', '-change:מדות', '-to:מידות', '-catr:מסכת מדות', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
#run(call + ['replace', '|מדות|', '|מידות|', '|מדות}}', '|מידות}}', '|על מדות|', '|על מידות|', '-catr:מסכת מדות', '-summary:התאמת שם המסכת לכתיב מלא בתבניות'])
#run(call + [site, main_user, 'rename bot', '-change:בכורים', '-to:ביכורים', '-catr:מסכת ביכורים', '-summary:שמות מסכתות בכתיב מלא, כפי שהוסכם במזנון'])
...
#run(call + ['split bot', '-titles', '-max_order:3', '-page:כד הקמח'])
#run(call + ['sources bot', '-page:כד הקמח'])
#run(call + ['replace', "''", '"', '-prefixindex:מנורת המאור (אבוהב)/הנר', '-summary:גרשיים'])
#run(call + ['split bot', '-titles', '-max_order:1', '-noinclude_titles', '-prefixindex:מנורת המאור (אבוהב)/הנר'])
...
#run(call + ['create redirect bot', '-change:נדה', '-to:נידה', '-prefixindex:חידושי הריטב"א על הש"ס/נדה', '-summary:הפניות מנידה לנדה'])
#run(call + ['create redirect bot', '-change:נדה', '-to:נידה', '-prefixindex:חידושי הרשב"א על הש"ס/נדה', '-summary:הפניות מנידה לנדה'])
...
#run(call + ['sources bot', '-page:שיחות הר"ן/שלם'])
...
#run(call + ['biur redirs'])
#run(call + ['keta 3.0', '-prefixindex:ר"ן על הרי"ף', '-regex:===\[\[רי"ף על הש"ס/.*?/דף ([ט-צ]?[א-ט]|[ט-צ]) עמוד ([אב])\|דף ..? עמוד [אב]\]\]===', '-group:1,2'])
#run(call + ['split bot', '-prefixindex:ביאור:ירושלמי מאיר/', '-regex:== ?(פרק .*?) ?[-–].*?=='])
