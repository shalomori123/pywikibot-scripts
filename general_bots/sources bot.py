...
class Sources:
	def __init__(self, text):
		...
		self.prefix = ['כמ"ש', 'כמש"כ', 'וכמ"ש', "ע'", 'עיין', "וע'", 'ועיין', "ר'", 'ראה', 'לשה"כ']
		self.suffix = ['ע"ש', 'עיין שם', 'וע"ש', 'יעוי"ש', 'וש"נ', 'וד"ל', 'ודו"ק', 'ואכמ"ל']
...
"תהלים", "משלי", "איוב", "שיר השירים", "איכה", "קהלת", "אסתר", #"רות", cause a lot of bugs
...
"ישעי'", "ירמי'", "נחמי'", "ד\"ה א'", "ד\"ה ב'", "ד\"ה א", "ד\"ה ב", "צפני'", "זכרי'", "תלים"]
		...
		text = re.sub(perek_regex+'\)(?!\])', '{{הפ|\\1|\\3\\4\\5}}', text)
		text = re.sub(perek_regex+'[ :](?:פס[\'׳] |פסוק |)(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט]))\)(?!\])', '{{הפ|\\1|\\3\\4\\5|\\7\\8\\9}}', text)
		text = re.sub(perek_regex+'[ :](?:פס[\'׳] |פסוקים |)(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט])) ?- ?(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט]))\)(?!\])', '{{הפ|\\1|\\3\\4\\5|\\7\\8\\9|\\11\\12\\13}}', text)
		
		#book outside ()
		perek_regex = books_reg+' \((?:פ[\'׳] |פרק |פ[״"]?|)(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט])),?'
		text = re.sub(perek_regex+'\)(?!\])', '\\1 {{הפ|\\1|\\3\\4\\5}}', text)
		text = re.sub(perek_regex+'[ :](?:פס[\'׳] |פסוק |)(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט]))\)(?!\])', '\\1 {{הפ|\\1|\\3\\4\\5|\\7\\8\\9}}', text)
		text = re.sub(perek_regex+'[ :](?:פס[\'׳] |פסוקים |)(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט])) ?- ?(([א-צ])[׳\']?|([ט-צ])[״"]?([א-ט]))\)(?!\])', '\\1 {{הפ|\\1|\\3\\4\\5|\\7\\8\\9|\\11\\12\\13}}', text)
